!function e(t, r, n) {
    ...
    , {
        "../../shared/modules/provider-injection": 155,
        ...
        (function(r, n) {
            (function() {
                ...
                b.prototype.read = function(e) {
                    ...
                    t.sync = !1,
                    t.reading || (e = S(r, t))),
                    null === (n = e > 0 ? I(e, t) : null) ? (t.needReadable = !0,
                    e = 0) : t.length -= e,
        ...
        (function(t, n) {
            (function() {
                ...
                r.format = function(e) {
                    ...
                    r = 1;
                    for (var n = arguments, s = n.length, o = String(e).replace(i, (function(e) {
                        if ("%%" === e)
                            return "%";
                        if (r >= s)
                            return e;
                ...
                function l(e, t, n) {
                    ...
                    E(t) && (o.indexOf("message") >= 0 || o.indexOf("description") >= 0))
                        return f(t);
                    if (0 === o.length) {
                        if (S(t)) {
                            var u = t.name ? ": " + t.name : "";
                    ...
                    E(t) && (w = " " + f(t)),
                    0 !== o.length || R && 0 != t.length ? n < 0 ? b(t) ? e.stylize(RegExp.prototype.toString.call(t), "regexp") : e.stylize("[Object]", "special") : (e.seen.push(t),
                    c = R ? function(e, t, r, n, i) {
                        for (var s = [], o = 0, a = t.length; o < a; ++o)
                            C(t, String(o)) ? s.push(h(e, t, r, n, String(o), !0)) : s.push("");
                ...
                function b(e) {
                    return w(e) && "[object RegExp]" === R(e)
                }
                function w(e) {
                    return "object" == typeof e && null !== e
                }
                function _(e) {
                    return w(e) && "[object Date]" === R(e)
                }
                function E(e) {
                    return w(e) && ("[object Error]" === R(e) || e instanceof Error)
                }
                function S(e) {
                ...
                r.log = function() {
                    ...
                    [e.getDate(), M[e.getMonth()], t].join(" ")), r.format.apply(r, arguments))
                }
                ,
 ...
 */
    ...
    , {
        "./JsonRpcEngine": 78,
        "./createAsyncMiddleware": 79,
        "./createScaffoldMiddleware": 80,
        "./getUniqueId": 81,
        "./idRemapMiddleware": 82,
        "./mergeMiddleware": 84
    }],
    84: [function(e, t, r) {
        "use strict";
    ...
    , {
        "./createEngineStream": 85,
        "./createStreamMiddleware": 86
    }],
    88: [function(e, t, r) {
        !function(e, r) {
            "use strict";
    ...
    , {
        "./_stream_duplex": 94,
        "./internal/streams/BufferList": 99,
        "./internal/streams/destroy": 100,
        "./internal/streams/stream": 101,
        _process: 92,
        "core-util-is": 62,
        events: 58,
        inherits: 74,
    ...
    106: [function(e, t, r) {
        class n {
            ...
            parseRange(e) {
                ...
                a("comparator trim", e);
                let u = (e = (e = (e = e.replace(c[l.TILDETRIM], h)).replace(c[l.CARETTRIM], d)).split(/\s+/).join(" ")).split(" ").map((e=>b(e, this.options))).join(" ").split(/\s+/).map((e=>O(e, this.options)));
            ...
            test(e) {
                ...
                for (let t = 0; t < this.set.length; t++)
                    if (j(this.set[t], e, this.options))
                        return !0;
                return !1
            }
        }
        ...
        class l {
            constructor(t, r) {
                ...
                t instanceof l) {
                    ...
                    throw new TypeError(`Invalid Version: ${e("util").inspect(t)}`);
                if (t.length > i)
                ...
                const c = t.trim().match(r.loose ? o[a.LOOSE] : o[a.FULL]);
                if (!c)
    ...
    , {
        ...
        "./internal/re": 137,
        "./ranges/gtr": 138,
        "./ranges/intersects": 139,
        "./ranges/ltr": 140,
        "./ranges/max-satisfying": 141,
        "./ranges/min-satisfying": 142,
        "./ranges/min-version": 143,
        "./ranges/outside": 144,
        "./ranges/simplify": 145,
        "./ranges/subset": 146,
        "./ranges/to-comparators": 147,
        "./ranges/valid": 148
    }],
    133: [function(e, t, r) {
    ...
    155: [function(e, t, r) {
        ...
        r.default = function() {
            return function() {
                ...
                const e = ["execution.metamask.io", "uscourts.gov", "dropbox.com", "webbyawards.com", "cdn.shopify.com/s/javascripts/tricorder/xtld-read-only-frame.html", "adyen.com", "gravityforms.com", "harbourair.com", "ani.gamer.com.tw", "blueskybooking.com", "sharefile.com"]
